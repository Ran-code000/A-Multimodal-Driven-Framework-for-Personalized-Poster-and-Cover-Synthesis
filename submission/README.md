...
| 序号 | 内容 | 文件 | 状态 |
|------|------|------|:----:|
| 1 | 期末结题报告 | `final_report.pdf` | ✅ |
| 2 | 开题报告 | `proposal.pdf` | ✅ |
| 3 | 源代码 | `engine.py`, `app.py`, `evaluation.py` 等 | ✅ |
| 4 | README | `README.md` | ✅ |
| 5 | 环境依赖 | `requirements.txt` | ✅ |
| 6 | 定量实验结果 | `evaluation_v2_output/metrics.json` | ✅ |
| 7 | 可视化结果 | `summary_grid.png`, `grid_*.png` | ✅ |
| 8 | Demo 视频 | 3--5 分钟录屏，链接填入 `demo_video_link.txt` | ⬜ |
| 9 | GitHub 仓库 | 推送至远程，更新下方克隆地址 | ⬜ |
| 10 | 上台展示 PPT | 第 16--17 周现场展示 | ⬜ |
...
5. **生成海报** — 点击"Generate Poster"，等待 15--25 秒即可获得 1024x1024 海报
...
├── gen_one.py                       # 单张海报生成脚本
├── gen_v2.py                        # 批量生成脚本
├── eval_v2.py                       # V2 自动化评测流水线
├── evaluation.py                    # 完整评测脚本
├── compute_metrics.py               # CLIP Score / FID / 美学指标计算
├── compute_v2_metrics.py            # V2 指标计算
├── test_pipeline.py                 # 流水线验证与 OOM 检测
├── requirements.txt                 # Python 依赖清单
├── README.md                        # 本文件
├── demo_video_link.txt              # Demo 演示视频链接（上传后填写）
│
├── proposal.pdf                     # 开题报告
├── final_report.pdf                 # 期末结题报告
│
├── evaluation_v2_output/            # 评测生成结果
│   ├── *_G1_TextOnly.png            # 各主题 G1 纯文本基线
│   ├── *_G2_ControlNet.png          # 各主题 G2 仅布局控制
│   ├── *_G3_IPAdapter.png           # 各主题 G3 仅风格控制
│   ├── *_G4_FullSystem.png          # 各主题 G4 完整多模态
│   ├── grid_*.png                   # 4 张 2x2 主题对比网格
│   ├── summary_grid.png             # 4x4 主汇总对比图
│   └── metrics.json                 # 全量定量指标（JSON）
│
├── test_output_text_only.png        # 纯文本基线生成样例
├── test_output_full_pipeline.png    # 完整多模态生成样例
├── ui.png                           # Gradio 界面截图
├── test1.jpg ~ test4.jpg            # 四类风格参考图
└── 1.png                            # 报告用插图
```
...
|--------|:----------:|:----------:|:-------:|:-------:|
| G1 纯文本基线 | x | x | 0.0 | 0.0 |
| G2 仅布局控制 | v | x | 0.55 | 0.0 |
| G3 仅风格控制 | x | v | 0.0 | 0.40 |
| G4 完整多模态 | v | v | 0.55 | 0.40 |
...
1. Podell D, English Z, Lacey K, et al. *SDXL: Improving Latent Diffusion Models for High-Resolution Image Synthesis.* arXiv:2307.01952, 2023.
...
4. Rombach R, Blattmann A, Lorenz D, et al. *High-Resolution Image Synthesis with Latent Diffusion Models.* CVPR, 2022.
5. Jin C, Xu H, Song R, Lu Z. *Text2Poster: Laying Out Stylized Texts on Retrieved Images.* ICASSP, 2022.
6. Hsu HY, He X, Peng Y, Kong H, Zhang Q. *PosterLayout: A New Benchmark and Approach for Content-Aware Visual-Textual Presentation Layout.* CVPR, 2023.
